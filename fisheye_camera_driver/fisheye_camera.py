...
class FisheyeCameraNode(Node): 
    def __init__(self):
        ...
        command = f"ffmpeg -fflags nobuffer -framerate 60 -i /dev/video{self.video_device} -pix_fmt bgr24 -f rawvideo -" # Captures video frames at 60 fps from the specified video device and streams raw BGR24 video data, '-fflags nobuffer' to minimize internal buffering
